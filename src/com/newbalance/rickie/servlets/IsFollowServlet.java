...
public class IsFollowServlet extends AbstractServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try{
			...
			//判断是哪种请求
			if( code.equals(Macro.CODE_WHETHER_FOLLOW_OR_NOT) ){
				...
				boolean isFollow = followServ.isFollow(user_id, follower_id);
				if( isFollow )
					result.put("code", Macro.CODE_ALREADY_FOLLOW);
				else
					result.put("code", Macro.CODE_NOT_YET_FOLLOW);
