...
public class GetFansNumServlet extends AbstractServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try{
			...
			//判断是哪种请求
			if( code.equals( Macro.CODE_GET_FANS_NUMBER ) ){
				
				int user_id = Integer.valueOf( req.getParameter("user_id") );
				FollowerModuleService followServ = new FollowerModuleServiceImp();
				int fansNum = followServ.getFansNum(user_id);
				data.put("fans_num", fansNum);
				result.put("code", Macro.CODE_FANS_NUMBER_RETURNED);
